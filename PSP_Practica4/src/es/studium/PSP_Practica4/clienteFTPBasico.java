package es.studium.PSP_Practica4;
...
public class clienteFTPBasico extends JFrame 
{
	...
	public clienteFTPBasico() throws IOException
	{
		...
		barraDesplazamiento.setBounds(new Rectangle(55, 204, 335, 434));
		...
		btnVolverDirectorio.setBounds(432, 294, 192, 29);
		c.add(btnVolverDirectorio);	
		btnRenombrarDirectorio.setBounds(432, 384, 192, 29);
		c.add(btnRenombrarDirectorio);
		btnRenombrarFichero.setBounds(432, 519, 192, 29);
		c.add(btnRenombrarFichero);
		btnSubirFichero.setBounds(432, 429, 192, 29);
		c.add(btnSubirFichero);
		btnCreaDir.setBounds(432, 204, 192, 29);
		c.add(btnCreaDir);
		btnDelDir.setBounds(432, 339, 192, 29);
		c.add(btnDelDir);
		btnDescargar.setBounds(432, 474, 192, 29);
		c.add(btnDescargar);
		btnEliminarFichero.setBounds(432, 564, 192, 29);
		c.add(btnEliminarFichero);
		btnSalir.setBounds(432, 609, 192, 29);
		c.add(btnSalir);
		c.setLayout(null);
		...
		btnEntrarEnDirectorio.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// Doble clic para acceder a la función
				if(arg0.getClickCount() == 2)
				{
					String nombreDir = JOptionPane.showInputDialog("Introduce el nombre del directorio:");
					//quita blancos a derecha y a izquierda
					String nombre = nombreDir.trim();
					txtArbolDirectoriosConstruido.setText(nombre);
					try
					{
						//directorio de trabajo actual
		...
		btnRenombrarFichero.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				String nombreDir = JOptionPane.showInputDialog("Introduce el nombre del fichero a renombrar:");
